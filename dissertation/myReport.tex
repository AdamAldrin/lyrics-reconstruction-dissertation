...
\usepackage{float}% Added for table 3.1
\usepackage{amsmath}% Added for equations used in 3.6
\usepackage{tikz}% Added valence arousal 
...
\large \emph{A report submitted in fulfilment of the requirements}\\ \emph{for the degree of} your degree (e.g. BSc in Computer Science)\\[0.3cm] 
\textit{in the}\\[0.3cm]
